   ...
   <main>
     <section>
       <article id="login_find_wrap">
         <!--페이지 이름-->
         <div class="login_find_title">비밀번호 찾기</div>
         <!--유저 정보 입력하는 곳-->
         <form action="find_member_pw.php" method="get" class="member_form">
					 <input type="text" value="findPw" name="page" style="visibility : hidden; display : none;">
			<input class="login_find_write" type="text" name="user_id" value=""
